    ...
    return (
        ...
        <div className={styles.wrapper}>
            <div className={styles.textInfo}>
                ...
                <h5> When individuals follow a vegetarian diet that provides them with the adequate nutrients they need, this type of diet can result in a number of health benefits. Appropriately planned vegetarian diets are not only nutritionally beneficial and may prevent and treat certain diseases, but they are also more environmentally sustainable because they use fewer natural resources than diets rich in animal products. Studies have repeatedly shown that vegetarian diets benefit long-term health. Vegetarian diets are associated with lower body mass index and can be used to achieve and maintain a healthy weight. Additionally, vegetarians have lower incidence of heart disease, diabetes and cancer. Find out more on this article by Harvard Medical School!</h5>
